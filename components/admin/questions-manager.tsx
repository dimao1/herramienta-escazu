          ...
          <Card key={question.id}>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <Badge variant={question.question_type === "statement" ? "default" : "secondary"}>
                      {question.question_type === "statement" ? "Declaración" : "Abierta"}
                    </Badge>
                    <Badge variant="outline">Orden: {question.order_index}</Badge>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                {Object.entries(question.recommendations).map(([key, value]) => (
...
function QuestionForm({ question, modules, onSave, onCancel }: QuestionFormProps) {
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value: "statement" | "open") => setFormData((prev) => ({ ...prev, question_type: value }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
          ...
          {Object.entries(formData.recommendations).map(([key, value]) => (
            <div key={key} className="flex gap-2">
              ...
              <Textarea
                ...
                className="flex-1"
              />
              <Button type="button" size="sm" variant="outline" onClick={() => removeRecommendation(key)}>
                <X className="h-4 w-4" />
              </Button>
            </div>
          ))}
