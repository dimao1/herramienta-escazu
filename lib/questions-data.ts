...
export const questionsData = [
  {
    id: 1,
    module_id: 1,
    question_text: "1. Actualizo el menu transparencia y acceso a la información de manera mensual",
    question_type: "statement" as const,
    order_index: 1,
    recommendations: {
      "Sí - Básico":
        "Elabore lineamientos (protocolo, guía, instructivo, procedimiento, etc) en el que se establezca los pasos y responsabilidades para la publicación y actualización de la información conforme al artículo 9 de la Ley 1712 de 2014 y a la resolución 1519 de 2020, asegurando que los contenidos estén disponibles, actualizados y sean accesibles para la ciudadanía.",
      "Sí - Intermedio":
        "Elabore el esquema de publicación (uno de los instrumentos de la información obligatorios por la Ley 1712 de 2014). Si ya lo tiene revisélo y actualícelo. Establezca sistema de revisión de la página y alertas para verificar que la información se encuentra actualizada de manera oportuna.",
      "Sí - Avanzado":
        "Continúe con el proceso de validación de la información y actualización en la página web. Verifique periodicamente el cumplimiento de los requisitos establecidos en la resolucuón 1519 de 2020. Además de la actualización de la información, incorpore mejoras como el uso del lenguaje claro, formatos accesibles, traducción de información relevante a dialectos y lenguas del territorio, entre otros.",
      No: "Revise la normatividad vigente (Ley 1712 de 2014, resolución 1519 de 2020, Acuerdo de Escazú) y establezca ruta o plan de trabajo para dar cumplimiento. Sensibilice sobre el derecho de acceso a la información pública e información ambiental. Inicie con la implementación de la ruta o plan de trabajo.",
      "No aplica":
  ...
  },
  {
    id: 2,
    module_id: 1,
    question_text: "2. Actualizo el menu participa de manera mensual",
    question_type: "statement" as const,
    order_index: 2,
    recommendations: {
      "Sí - Básico":
        "Revise los requisitos que la resolución 1519 de 2020 establece para el menú participa y realice los ajustes necesarios en la página web para dar cumplimiento a los mismos. Socialice con las áreas responsables de promover la participación y establezca criterios para la publicación de la información correspondiente de manera oportuna.",
      "Sí - Intermedio":
        "Establezca un sistema de actualización de la información (protocolo, procedimiento, instructivo, etc) en el que las áreas responsables de promover la participación remitan de manera la información correspondiente para ser publicada en el menú participa. Socialice y capacite.",
      "Sí - Avanzado":
        "Continúe con la actualización periodica y oportuna de los espacios y demás acticvidades que promuevan la participación (convocatorias, espacios de dialogo, talleres, informes, etc) Incorpore resultados, visibilización de compromisos, seguimiento, datos abiertos e informes en lenguaje claro. Permita espacios de rertoalimentación.",
      No: 'Establezca un cronograma de actualización mensual del menú "Participa", de acuerdo con el Decreto 1499 de 2017, la resolución 1519 de 2020, los lineamientos de Gobierno Digital y el Acuerdo de Escazú, promoviendo mecanismos efectivos de participación ciudadana.',
      "No aplica":
        "Revise en la normatividad vigente si en realidad esto no le aplica a su entidad y en la siguiente casilla justifique su elección con base en el criterio jurídico de su entidad.",
    },
  },
